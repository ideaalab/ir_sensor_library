 ...
 * Compañia: IDEAA Lab (http://www.ideaalab.com)
 * 
 * Basada en la libreria QTRSensors de Pololu (https://www.pololu.com/docs/0J19)
 */
...
#ifdef IR_VARIABLE_TIMES
long IR_MAX_VALUE = 2000;
long IR_CUT_VALUE = 2000;
#endif